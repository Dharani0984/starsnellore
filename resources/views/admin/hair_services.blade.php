...
<!-- main content start-->
	...
	<!-- for amcharts js -->
			...
			<script src="{{ asset('public/js/export.min.js') }}"></script>
			<link rel="stylesheet" href="{{ asset('public/css/export.css') }}" type="text/css" media="all" />
			<script src="{{ asset('public/js/light.js') }}"></script>
	<!-- for amcharts js -->

    <script  src="{{ asset('public/js/index1.js') }}"></script>
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
					...
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider1.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider2.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider3.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider4.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider5.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('public/images/slider6.jpg') }}" alt="name">
						</div>
						<div class="item">
